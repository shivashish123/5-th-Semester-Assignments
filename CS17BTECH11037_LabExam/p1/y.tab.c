...
{
  "$end", "error", "$undefined", "TABLE", "COMD", "COMI", "COMR", "COMP",
  "OPP", "OPS", "OPD", "OPJ", "IPADDR", "NAME", "NUMB", "IPTABLE", "space",
  "newline", "$accept", "S", "line", "IPT", "OPTIONS", "OPTION", YY_NULLPTR
};
#endif
...
{
     -11,   -12,     5,   -11,     3,   -12,   -12,     8,    14,    17,
      18,     9,    -8,    10,    12,    11,    13,    15,    19,    16,
       4,    20,     4,     4,    21,   -12,   -12,   -12,   -12,   -12,
      22,   -12,   -12,    23,   -12,   -12,   -12
};
...
{
       0,    14,     0,     3,     0,     1,     2,     0,     0,     0,
       0,     0,     0,     0,     0,    11,     0,     0,     0,     0,
       0,    10,    16,     0,    12,     6,    17,    18,    19,    20,
       9,     5,    15,    13,     7,     4,     8
};
...
{
      16,    17,    18,    19,     1,     5,    20,     7,     8,     9,
      10,    11,    16,    17,    18,    19,    30,    12,    32,    33,
      13,    14,     0,    15,    23,    24,    26,    27,    25,    29,
       6,    28,     0,     0,     0,     0,     0,    31,    34,    35,
      36
};

static const yytype_int8 yycheck[] =
{
       8,     9,    10,    11,    15,     0,    14,     4,     5,     6,
       7,     3,     8,     9,    10,    11,    20,     3,    22,    23,
       3,     3,    -1,    14,    14,    13,    13,    12,    17,    13,
       3,    12,    -1,    -1,    -1,    -1,    -1,    17,    17,    17,
      17
};
...
{
       0,    15,    19,    20,    21,     0,    19,     4,     5,     6,
       7,     3,     3,     3,     3,    14,     8,     9,    10,    11,
      14,    22,    23,    14,    13,    17,    13,    12,    12,    13,
      22,    17,    22,    22,    17,    17,    17
};
